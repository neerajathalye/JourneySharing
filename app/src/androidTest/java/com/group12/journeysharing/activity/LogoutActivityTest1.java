...
public class LogoutActivityTest1 {
    ...
    @Test
    public void logoutActivityTest1() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.emailField),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("qiu@tcd.ie"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.emailField), withText("qiu@tcd.ie"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.emailField), withText("qiu@tcd.ie"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("qiux@tcd.ie"));

        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.emailField), withText("qiux@tcd.ie"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
