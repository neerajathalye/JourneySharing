...
public class BookJourneyActivity extends AppCompatActivity implements View.OnClickListener, AlertDialogCallback<List<String>>, RadioGroup.OnCheckedChangeListener, SeekBar.OnSeekBarChangeListener {
...
//            add = add + "\n" + obj.getLocality();
    ...
    public void showDateTimePicker() {
        ...
        new DatePickerDialog(BookJourneyActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                calendar.set(year, monthOfYear, dayOfMonth);
                new TimePickerDialog(BookJourneyActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
